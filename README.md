...
Também sei trabalhar com banco de dados (MySQL, SQLServer ou PostgreSQL) e API's Rest.

Durante meus estudos, aprendi a usar ferramentas de versionamento de código (Git, Github).

Estudando, adquiri boas práticas de desenvolvimento como, Clean Code e SOLID.

Não é meu objetivo, mas possuo conhecimento WEB com HTML, CSS E JavaScript (e Angular).
